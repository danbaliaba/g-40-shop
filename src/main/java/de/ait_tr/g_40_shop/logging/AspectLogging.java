...
//        }catch (Throwable e){
//            logger.error("Method {} of the class ProductServiceImpl threw an exception: {}",methodName, e.getMessage());
//        }
//
...
//    }
    ...
    public Object aroundVoidsServiceImpl(ProceedingJoinPoint joinPoint) throws Throwable {
        String methodName = joinPoint.getSignature().getName();
    ...
    @AfterThrowing(pointcut = "allServiceImplVoids()",
    throwing = "e")
    public void afterThrowingIfProductNotFound(Exception e) {
        logger.warn("Method getById of the class ProductServiceImpl threw an exception {}", e.getMessage());
    }
